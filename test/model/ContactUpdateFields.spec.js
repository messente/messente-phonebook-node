...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PhonebookApi.ContactUpdateFields();
  });
  ...
  describe('ContactUpdateFields', function() {
    it('should create an instance of ContactUpdateFields', function() {
      ...
      //var instance = new PhonebookApi.ContactUpdateFields();
      //expect(instance).to.be.a(PhonebookApi.ContactUpdateFields);
    });
