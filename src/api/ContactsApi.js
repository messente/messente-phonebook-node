...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContactEnvelope', 'model/ContactFields', 'model/ContactListEnvelope', 'model/ContactUpdateFields', 'model/EmptyObject', 'model/ErrorResponse', 'model/GroupListEnvelope'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ContactEnvelope'), require('../model/ContactFields'), require('../model/ContactListEnvelope'), require('../model/ContactUpdateFields'), require('../model/EmptyObject'), require('../model/ErrorResponse'), require('../model/GroupListEnvelope'));
  } else {
    // Browser globals (root is window)
    if (!root.PhonebookApi) {
      root.PhonebookApi = {};
    }
    root.PhonebookApi.ContactsApi = factory(root.PhonebookApi.ApiClient, root.PhonebookApi.ContactEnvelope, root.PhonebookApi.ContactFields, root.PhonebookApi.ContactListEnvelope, root.PhonebookApi.ContactUpdateFields, root.PhonebookApi.EmptyObject, root.PhonebookApi.ErrorResponse, root.PhonebookApi.GroupListEnvelope);
  }
}(this, function(ApiClient, ContactEnvelope, ContactFields, ContactListEnvelope, ContactUpdateFields, EmptyObject, ErrorResponse, GroupListEnvelope) {
  'use strict';
