...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorResponse', 'model/GroupEnvelope', 'model/GroupListEnvelope', 'model/GroupName'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/GroupEnvelope'), require('../model/GroupListEnvelope'), require('../model/GroupName'));
  } else {
    // Browser globals (root is window)
    if (!root.PhonebookApi) {
      root.PhonebookApi = {};
    }
    root.PhonebookApi.GroupsApi = factory(root.PhonebookApi.ApiClient, root.PhonebookApi.ErrorResponse, root.PhonebookApi.GroupEnvelope, root.PhonebookApi.GroupListEnvelope, root.PhonebookApi.GroupName);
  }
}(this, function(ApiClient, ErrorResponse, GroupEnvelope, GroupListEnvelope, GroupName) {
  'use strict';
